...
const CATALOG: Array<[string, string, string, string]> = [
  ...
  ['2025 Topps Stadium Club UFC Hobby Box', 'BOX', '887521148042', 'Combat'],
  ...
  ['2026 Topps Knockout UFC Hobby 8-Box Case', '7138', '887521157327', 'Combat'],
  ...
  ['2026 Topps Cosmic Chrome WWE Wrestling Hobby 8-Box Case', '7160', '887521156023', 'Combat'],
  ['2026 Topps Chrome UFC Delight 8-Box Case', '7128', '887521153626', 'Combat'],
